  ...
  return (
    <section id="market" className="relative py-24 md:py-40 bg-[#050505] overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
          <div className="absolute top-0 right-0 w-1/2 h-full bg-[#C5A028]/5 blur-[160px] rounded-full opacity-30" />
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            <div className="relative group overflow-hidden rounded-[32px] border border-white/10 shadow-2xl aspect-video lg:aspect-[16/9]">
                ...
                <div className="absolute bottom-8 left-8 right-8 flex justify-between items-end">
                    <p className="text-white font-serif italic text-2xl drop-shadow-lg text-left">"In einem Markt der Knappheit <br/> ist Exklusivität die Währung."</p>
            ...
            <div className="text-left space-y-8">
                <div className="flex items-center gap-4">
                    ...
                    <p className="text-[11px] text-[#C5A028] uppercase tracking-[0.4em] font-bold">Marktplatz</p>
                </div>
                <h3 className="text-4xl md:text-5xl font-serif text-white leading-tight">
                  Begehrlichkeit durch <br />
                  <span className="text-[#C5A028] italic">Selektion.</span>
                </h3>
                <p className="text-lg text-white/50 leading-relaxed font-light">
                  Meerbusch-Büderich ist kein gewöhnlicher Markt. Hier zählt Vertrauen und Diskretion. 
                  Unser Vertriebskonzept setzt auf eine gezielte Ansprache und hochwertige 
                  Präsentationen, um den Wert des Assets optimal zu transportieren.
                </p>
                <div className="flex flex-col sm:flex-row gap-6">
                  <button className="flex items-center justify-center gap-4 px-10 py-5 rounded-full bg-white/5 border border-white/10 text-white hover:bg-white hover:text-black transition-all group/btn font-bold text-[10px] uppercase tracking-widest shadow-2xl">
                    Vertriebs-Exposé laden <ArrowUpRight className="w-4 h-4 transition-transform group-hover/btn:translate-x-1 group-hover/btn:-translate-y-1" />
                  </button>
                </div>
            </div>
