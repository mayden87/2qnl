...
const Hero: React.FC = () => {
  ...
  return (
    <header className="relative h-[100dvh] w-full flex flex-col justify-center overflow-hidden">
      ...
      {/* Content Layer - Strictly Left Aligned */}
      <div className="max-w-[1400px] w-full mx-auto px-6 md:px-12 relative z-10 flex flex-col h-full justify-center pt-20">
        ...
        <div className="max-w-4xl text-left">
          ...
          <div className={`transition-all duration-1000 delay-300 ${isMounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
             <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full border border-white/10 bg-black/40 backdrop-blur-md mb-8 md:mb-10">
                <span className="w-1.5 h-1.5 rounded-full bg-[#C5A028] animate-pulse"></span>
                <span className="text-[9px] uppercase tracking-[0.25em] text-white/90 font-bold">Confidential Memorandum</span>
             </div>
          </div>

          {/* Main Title - Masked Reveal Animation */}
          <h1 className="font-serif font-medium text-white leading-[1.05] tracking-tighter mb-8 md:mb-12 text-left">
            ...
            <div className="mask-container overflow-hidden mt-2">
          ...
          <div className={`flex flex-col md:flex-row gap-8 items-start transition-all duration-1000 ease-out delay-[800ms] ${isMounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <p className="text-base md:text-lg text-white/60 max-w-md leading-relaxed font-light font-sans tracking-wide text-left">
            ...
            {/* Stats - Left aligned */}
            <div className="flex gap-8 border-t border-white/10 pt-6 md:pt-0 md:border-t-0 md:border-l md:pl-10 md:ml-4">
               <div className="text-left">
                  <p className="text-[9px] text-text-muted uppercase tracking-[0.2em] font-bold mb-2">Volumen</p>
                  <p className="text-white font-serif text-2xl">22,3 Mio. €</p>
               </div>
               <div className="text-left">
                  <p className="text-[9px] text-text-muted uppercase tracking-[0.2em] font-bold mb-2">Rendite</p>
                  <p className="text-[#C5A028] font-serif text-2xl">~34,9%</p>
               </div>
            </div>
          </div>
        </div>
