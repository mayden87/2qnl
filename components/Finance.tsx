...
import { SectionTag, Stage, Reveal, MetricRow } from './ui/Shared';
import { TrendingUp, BarChart3, Wallet, ArrowUpRight, ChevronRight } from 'lucide-react';

const Finance: React.FC = () => {
  return (
    <section id="finance" className="relative py-24 md:py-40 bg-[#050505]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            <div className="relative group overflow-hidden rounded-[32px] border border-white/10 shadow-2xl aspect-video lg:aspect-[16/9]">
                <img
                    ...
                    alt="Wirtschaftlichkeit und Ertrag"
                ...
                <div className="absolute bottom-8 left-8 right-8 flex justify-between items-end">
                    <p className="text-white font-serif italic text-2xl drop-shadow-lg text-left">"Rentabilität ist das Resultat <br/> präziser Projektsteuerung."</p>
            ...
            <div className="text-left space-y-8">
                <div className="flex items-center gap-4">
                    ...
                    <p className="text-[11px] text-[#C5A028] uppercase tracking-[0.4em] font-bold">Wertsteigerung</p>
                </div>
                <h3 className="text-4xl md:text-5xl font-serif text-white leading-tight">
                  Nachhaltige <br />
                  <span className="text-[#C5A028] italic">Wertschöpfung.</span>
                </h3>
                <p className="text-lg text-white/50 leading-relaxed font-light">
                  Die Kombination aus exzellenter Lage in Meerbusch-Büderich und einem bereits 
                  fortgeschrittenen Planungsstand minimiert das Risiko und sichert eine 
                  überdurchschnittliche Rendite. Unsere Kalkulation basiert auf realen Marktpreisen 
                  und konservativen Baukostenschätzungen.
                </p>
                <div className="flex flex-col sm:flex-row gap-6">
                  <button className="flex items-center justify-center gap-4 px-10 py-5 rounded-full bg-[#C5A028] text-black hover:bg-white transition-all group/btn font-bold text-[10px] uppercase tracking-widest shadow-2xl">
                    GKI-Details laden <ArrowUpRight className="w-4 h-4 transition-transform group-hover/btn:translate-x-1 group-hover/btn:-translate-y-1" />
                  </button>
                  <button className="flex items-center justify-center gap-4 px-10 py-5 rounded-full bg-white/5 border border-white/10 text-white hover:bg-white hover:text-black transition-all font-bold text-[10px] uppercase tracking-widest">
                    Szenarien prüfen <ChevronRight className="w-4 h-4" />
                  </button>
                </div>
            </div>
