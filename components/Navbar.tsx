...
const NAV: NavItem[] = [
  ...
  { href: "#roadmap", label: "Roadmap", number: "03" },
  { href: "#mobility", label: "Mobilität", number: "04" },
  { href: "#tech", label: "Technik", number: "05" },
  { href: "#floorplans", label: "Architektur", number: "06" },
  { href: "#finance", label: "Kalkulation", number: "07" },
  { href: "#sensitivity", label: "Sensitivität", number: "08" },
  { href: "#market", label: "Markt", number: "09" },
  { href: "#contact", label: "Kontakt", number: "10" },
];
