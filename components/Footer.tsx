...
const Footer: React.FC = () => {
  ...
  const BRAND = {
    ...
    location: "Niederdonker Straße 81 · 40667 Meerbusch-Büderich · Deutschland",
  ...
  const NAV = [
    ...
    { href: "#planning", label: "Planung", meta: "Genehmigung" },
    { href: "#mobility", label: "Mobilität", meta: "Stellplätze" },
    { href: "#floorplans", label: "Architektur", meta: "Grundrisse" },
